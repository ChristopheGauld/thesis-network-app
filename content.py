...
STUDIES = [
    ...
    },
    {
        ...
        "clinical": "Articuler sémiologie et activité cérébrale comme un système distribué",
        "accent": "#9B8CFF",
    },
]
...
PRINCIPLES = [
    ...
    ("EXPLICATION", "Les mécanismes internes doivent être reliés aux symptômes et au contexte, sans avoir à chercher une cause unique"),
]

LIMITS = [
    "Réseaux populationnels : les associations observées ne décrivent pas nécessairement un individu",
    "Centralité : l'importance statistique ne signifie ni causalité directe, ni cible thérapeutique",
    "Études transversales : elles ne permettent pas d’inférer les dynamiques temporelles",
    "Réseau hybride en épileptologie : un nombre limité de sujets et un coefficient de stabilité relativement bas",
